...
numSort.sort(function(a:number,b:number):number{
    return a-b;
});
console.log(numSort);
...
//toSorted
let strArr3:string[] = ['d','e','i','a','c','m','s','b'];
let strArr3Sorted = strArr3.toSorted();
console.log(strArr3Sorted);

//toreversed

let strArr5 :string[] = ['d','e','i','a','c','m','s','b'];
...
let mixValue:any[]=['Ahmed','moiz',1,5,66,true,false]
...
let arrMap:number[]=[3,4,2,9,4,];
let retFun= arrMap.map(function(e){
    return e**3
})
console.log(retFun);

let arrReduce:number[]=[2,3,2,56,53];
let funReduce= arrReduce.reduce(function(prev,curr){
    return prev+curr
},0);

let arrmul:number[]=[2,4,3,3,3,22];
...
let arrsub1:number[]=[33,22,11,21,32];
